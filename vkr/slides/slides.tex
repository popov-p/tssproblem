...
\begin{document}
	...
	\begin{frame}{Результаты}
		\begin{figure}
			\includegraphics[width=\textwidth]{images/cost-history.png}
		\end{figure}
	\end{frame}
	\begin{frame}{Результаты}
		\begin{columns}[T]
	...
	\begin{frame}{Заключение}
		...
		Получены:
		\begin{itemize}
			\item Результаты, превосходящие исходные данные на 18 $\%$.
		\end{itemize}
	\end{frame}
	...
	\begin{frame}{Приложение. Места установки детекторов}
		\begin{figure}
			\includegraphics[width=\textwidth]{images/detectors-mapping.jpg}
		\end{figure}
	\end{frame}
	\begin{frame}{Приложение. Направления движения СО 1}
		\begin{figure}
			\includegraphics[width=\textwidth]{images/tl-destinations.png}
		\end{figure}
	\end{frame}

	\begin{frame}{Приложение. Модель дорожного участка}
		\begin{figure}
			\includegraphics[width=\textwidth]{images/sumo-gui-roadmap.png}
		\end{figure}
	\end{frame}
