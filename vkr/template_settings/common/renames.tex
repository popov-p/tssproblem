...
%%
%%
\newcommand{\Author}{П.С.\,Попов} % И.О. Фамилия автора 
\newcommand{\AuthorFull}{Попов Павел Сергеевич} % Фамилия Имя Отчество автора
\newcommand{\AuthorFullDat}{Попову Павлу Сергеевичу} % Фамилия Имя Отчество автора в дательном падеже (Кому? Студенту...)
\newcommand{\AuthorFullVin}{Попова Павла Сергеевича} % в винительном падеже (Кого? что?  Програмиста ...)
\newcommand{\AuthorPhone}{+7-950-861-06-60} % номер телефорна автора для оперативной связи  
\newcommand{\Supervisor}{В.В.\,Курц} % И. О. Фамилия научного руководителя
\newcommand{\SupervisorFull}{Курц Валентина Валерьевна} % Фамилия Имя Отчество научного руководителя
\newcommand{\SupervisorVin}{В.В.\,Курц} % И. О. Фамилия научного руководителя  в винительном падеже (Кого? что? Руководителя ...)
...
\newcommand{\SupervisorDegree}{к.ф.-м.н.} % степень
...
%%
%%
\renewcommand{\thesisTitle}{Расчет режимов работы светофорных объектов}
\newcommand{\thesisDegree}{работа бакалавра}% дипломный проект, дипломная работа, магистерская диссертация %c 2020
\newcommand{\thesisTitleEn}{Solution of traffic signal setting problem} %2020
\newcommand{\thesisDeadline}{17.06.2024}
\newcommand{\thesisStartDate}{08.10.2023}
...
%%
%%
\newcommand{\keywordsRu}{Микромоделирование дорожного трафика, оптимизация расстановки сигналов светофорных объектов, метаэвристические алгоритмы оптимизации, анализ данных} % ВВЕДИТЕ ключевые слова по-русски
%%
%%
\newcommand{\keywordsEn}{Microscopic traffic modelling, traffic signal setting optimization, metaheuristic optimization algorithms, data analysis} % ВВЕДИТЕ ключевые слова по-английски
%%
%%
...
\newcommand{\abstractRu}{В данной работе исследуется проблема оптимизации режимов работы светофорных объектов на дорожном участке. Изложена сущность подхода, основанная на использовании технологии микромоделирования автомобильного трафика и эволюционных алгоритмов оптимизации.\\
Результатом работы является конкретная программная реализация микромодели дорожного трафика, построенной на реальных данных, сравнение эффективности алгоритмов оптимизации, а также улучшение существующих программ регулировки дорожного движения.} % ВВЕДИТЕ текст аннотации по-русски
%%
%%
\newcommand{\abstractEn}{In this thesis, the problem of optimizing the operating modes of traffic lights on a road section is investigated. The essence of the approach is based on the use of microscopic traffic flow simulation and evolutionary optimization algorithms.\\

The result of the work is a specific software implementation of a microscopic traffic model based on real data, a comparison of the effectiveness of optimization algorithms, as well as an improvement of existing traffic control programs.} % ВВЕДИТЕ текст аннотации по-английски
