	\begin{algorithm} %[h]
		...
		\nonl\myalg{\algoDTestsFDSCALING}{
			\KwInput{\\Количество поколений $n$,\\ количество $p$ скрещивающихся родителей в поколении,\\
			количество $q$ хромосом в поколении,\\
			диапазон возможных значений времени фазы $[t_{min}, t_{max}]$.} 
		...
		\caption{Псевдокод генетического алгоритма \cite{Naidenova2017}}\label{alg:AlgoFDSCALING}
	\end{algorithm} 
